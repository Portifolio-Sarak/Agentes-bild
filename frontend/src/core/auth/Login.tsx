                ...
                >
                    ...
                    <div className="mt-8 space-y-3">
                        ...
                        <button
                            type="button"
                            onClick={() => {
                                setUsername('admin@erpmodelo.com');
                                setPassword('teste123');
                            }}
                            className="w-full py-3 bg-slate-900/50 hover:bg-slate-800 border border-slate-800 hover:border-emerald-500/50 text-emerald-400 rounded-2xl font-bold text-xs uppercase tracking-widest transition-all"
                        >
                            Entrar como Admin
                        </button>
                    </div>
